...
screen choose_character():
    add "images/character_select/bg character selection.png"
    #$ renpy.notify('Cheat mode enabled')
    imagebutton xalign 0.05 yalign 0.2:
        idle 'images/character_select/mc.png'
        hover 'images/character_select/mc poseing.png'
        action Jump("male_script_start")

    imagebutton xalign 0.95 yalign 0.2:
        idle 'images/character_select/fmc.png'
        hover 'images/character_select/fmc poseing.png'
        action Jump("female_script_start")


screen confirm_exit_to_menu():
    add "black.jpg"
    imagebutton xalign 0.45 yalign 0.5:
        idle "gui/button/choice_idle_background.png"
        hover "gui/button/choice_hover_background.png"
        action ShowMenu('main_menu')
    imagebutton xalign 0.45 yalign 0.55:
        idle "gui/button/choice_idle_background.png"
        hover "gui/button/choice_hover_background.png"
        action Return()
    text "Save your progress, before you exit\nDo you wish to exit to menu anyway?" xalign 0.5 yalign 0.36
    textbutton ("Yes"):
        xalign 0.475 yalign 0.5
        action Hide("imageHut"), ShowMenu('main_menu')
    textbutton ("No"):
        xalign 0.475 yalign 0.547
        action Return()
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton:
                idle im.Scale("back.png",60,60)
                hovered Play('sound', 'audio/game_sounds/button_hover.ogg')
                action Rollback()
            textbutton _("Back"):
                text_style "button_quick_menu"
                action Rollback()
        hbox:
            style_prefix "quick"
            ...
            yalign 0.989
            imagebutton:
                idle im.Scale("history.png",60,60)
        ...
        hbox:
            ...
            imagebutton:
                idle im.Scale("settings.png",57,57)
        ...
        hbox:
            ...
            yalign 0.989
            imagebutton:
                idle im.Scale("menu.png",57,57)
                action ShowMenu('confirm_exit_to_menu')
            textbutton _("Menu"):
                text_style "button_quick_menu"
                action ShowMenu('confirm_exit_to_menu')
            #textbutton _("Learn") action ShowMenu('about')
...
screen game_bar():
    ...
    textbutton "Learn" xalign 0.93 yalign 0.01:
        text_style "quick_learn_textbutton"
        action ShowMenu('about')
